    ...
    >
      <div className="banner-slide h-[400px] md:h-[500px] lg:h-[700px]">
        ...
        <div className="banner-overlay">
          ...
          <button className="banner-button text-xl">Learn More</button>
        </div>
      </div>
      <div className="banner-slide h-[400px] md:h-[500px] lg:h-[700px]">
        ...
        <div className="banner-overlay">
          ...
          <button className="banner-button text-xl">Get Started</button>
        </div>
      </div>
      <div className="banner-slide h-[400px] md:h-[500px] lg:h-[700px]">
        ...
        <div className="banner-overlay">
          ...
          <button className="banner-button text-xl">Enroll Now</button>
        </div>
      </div>
    </Carousel>
  );
